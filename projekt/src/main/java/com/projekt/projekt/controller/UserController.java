...
public class UserController {
	...
	@GetMapping("/users/{id}")
	public User getUsersById(@PathVariable(value = "id") Long iduser) {
	    return userRepository.findById(iduser)
	            .orElseThrow(() -> new ResourceNotFoundException("Book", "id", iduser));
	}
	
	@PutMapping("/user/{id}")
	public User updateUser(@PathVariable(value = "id") Long iduser,
